    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, help_text='Optional specific address or location description', max_length=300)),
        ...
        migrations.AddField(
            model_name='alert',
            name='community',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alerts', to='community.community'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='alert',
            index=models.Index(fields=['community', 'status'], name='community_a_communi_ae7a9a_idx'),
        ),
        migrations.AddIndex(
